...
nTrainSamples = 16000;
maxEpochs = 40;
learnRateA = 1e-2;   % Unfolded-A's loss converged cleanly at this rate -- keep it
learnRateB = 1e-3;   % was 1e-2 -- Unfolded-B's loss never beat its own epoch-1
                      % value and bounced noisily (0.12-0.14) instead of
                      % decreasing, the classic signature of too-high a
                      % learning rate for this loss landscape. Try 10x lower
                      % before concluding whether learning helps for Unfolded-B.
miniBatchSize = 32;
...
paramsA = trainUnfoldedLAS('A', trainData, K1, K2, maxEpochs, learnRateA, miniBatchSize);
...
paramsB = trainUnfoldedLAS('B', trainData, K1, K2, maxEpochs, learnRateB, miniBatchSize);
